...
public class MediaPlayerNotificationActivity extends AppCompatActivity {

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_media_player_notification);
  }

  @Deprecated
  public void onClickShowNotification(View view) {
    Intent activityIntent = new Intent(this, MediaPlayerNotificationActivity.class);
